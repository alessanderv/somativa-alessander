...
<div class="field">
   ...
   <h1> Lista de livros para empréstimo </h1>
    <br>
    <br>
    <div class="container">
    ...
    <div class="select is-fullwidth">
        ...
        <select name="livro">
            ...
            <div class="field">
                <div class="control">
                    <input name="livro_emprestado" type="text" class="input is-large" placeholder="Informe o número do livro escolhido!" autofocus>
                </div>
            </div>
                <div class="field">
                    <div class="control">
                ...
                <div class="field is-grouped">
                    <div class="control">
                        <button class="button is-link is-small">EMPRESTAR LIVRO</button>
                    </div>
    </div>
                </form>
            </div>
